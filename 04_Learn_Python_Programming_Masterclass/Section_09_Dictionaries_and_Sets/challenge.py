# Challenge time!
# We have mentioned that the data for the adventure game could be organised in
# many different ways.  We've created another way for you.
# Your mission, if you choose to accept it, is to change the code to make it
# work.
