...
class Song:
    ...
    Attributes:
        ...
        duration (int): The length of the song in seconds (may be zero)
    """
    ...
    def __init__(self, title, artist, duration=0):
        ...
        Args:
            ...
            duration (Optional[int]: Initial value for the 'duration' attribue.
...
class Album:
    ...
    Attributes:
        ...
        artist: (str): The name of the artist responsible for the album. If
            not specified, the artist will default to the artist with the name 
            "Varius Artists".
    ...
    def add_song(self, song, position=None):
        ...
        Args:
            ...
            position (Optional[int]): If specified, the song will be added at
                that position in the track list - inserting it between other
                songs if necessary. Otherwise, the song will be added to the
                end of the album list.
        """
...
def find_object(field, object_list):
    """
    Check object_list to see if an object with a name attribute field
    exists, return it if so.
    """
    ...
    with open("albums.txt", "r") as albums:
        for line in albums:
            ...
            if new_artist is None:
                ...
                # retrieve the artist object if there is one, otherwise create
                # a new artist object and add it to the artist list.
                new_artist = find_object(artist_field, artist_list)
                if new_artist is None:
                    new_artist = Artist(artist_field)
                    artist_list.append(new_artist)
            ...
            if new_album is None:
                new_album = Album(album_field, year_field, new_artist.name)
                new_artist.add_album(new_album)
            elif new_album.name != album_field:
                # We've just read a new album for the current artist
                # retrieve the album object if there is one, otherwise create
                # create a new album and add it to the current artist
